...
In proyectofinal-labels_en.properties:
proyectofinal=My application
proyectofinal[description]=My application does this and that

In proyectofinal-messages_en.properties:
